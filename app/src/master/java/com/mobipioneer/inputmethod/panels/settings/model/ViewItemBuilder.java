...
//                KeyboardPluginManager.getInstance().showPanel(HSApplication.getContext().getString(R.string.panel_theme));
    ...
    public static ViewItem getLanguageItem() {
        return new ViewItem("Add Language",
            ...
            @Override
            public void onItemClick(ViewItem item) {
//                HSGoogleAnalyticsUtils.getInstance().logKeyboardEvent(GAConstants.GA_PARAM_ACTION_SETTING_ADD_LANGUAGE_CLICKED);
...
//        stateListDrawable.addState(new int[]{android.R.attr.state_focused}, HSInputMethodTheme.getStyledDrawable(defPressedDrawable, SETTINGS_KEY_FONTS_PRESSED));
//        stateListDrawable.addState(new int[]{android.R.attr.state_pressed}, HSInputMethodTheme.getStyledDrawable(defPressedDrawable, SETTINGS_KEY_FONTS_PRESSED));
//        stateListDrawable.addState(new int[]{android.R.attr.state_selected}, HSInputMethodTheme.getStyledDrawable(defPressedDrawable, SETTINGS_KEY_FONTS_PRESSED));
//        stateListDrawable.addState(new int[]{}, HSInputMethodTheme.getStyledDrawable(defNormalDrawable, SETTINGS_KEY_FONTS));
