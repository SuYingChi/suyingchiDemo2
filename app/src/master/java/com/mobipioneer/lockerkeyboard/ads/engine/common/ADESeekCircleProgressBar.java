 ...
 * by bojia 2014-04-17
 */
public class ADESeekCircleProgressBar extends View {
    ...
    public ADESeekCircleProgressBar(Context context) {
        super(context);
    }

    public ADESeekCircleProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
