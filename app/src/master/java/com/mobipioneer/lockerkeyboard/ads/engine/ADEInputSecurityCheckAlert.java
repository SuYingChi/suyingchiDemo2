...
public class ADEInputSecurityCheckAlert extends RelativeLayout {
    ...
    private View layoutCheckResult;
    ...
    private boolean isCleanExpired = true;

    // auto quit
    private Timer timer;
    private TimerTask timerTask;
    private NativeAdView nativeAdView;
    private boolean adAvaliable;

    public ADEInputSecurityCheckAlert(Context context, String eventAction, String eventLabel) {
        super(context);

        this.eventAction = eventAction;
        this.eventLabel = eventLabel;

        LayoutInflater.from(context).inflate(R.layout.ad_engine_input_security_check, this);
...
//                HSGoogleAnalyticsUtils.getInstance().logKeyboardEvent(GAConstants.INPUT_SECURITY_CHECK_ALERT_CLOSE_CLICKED);
                dismiss();
            }
        });
        ...
        btnSetting.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                dismiss();
                ActivityUtils.showAdEngineItemSettingActivity(ADEConstants.ADE_ITEM_INPUT_SECURITY_CHECK);
            }
        });
        ...
        layoutCheckResult = layoutBoost.findViewById(R.id.ll_security_check_result);
...
//        }
        ...
        adAvaliable = NativeAdView.isLocalAdAvailable(getContext(), context.getString(R.string.ad_placement_boostdone));
...
//        GAnalyticsUtils.logEvent("Boost", "Boost_Window_Viewed");
    ...
    private void init_appear_Animation() {
        ...
        layoutCheckResult.setVisibility(INVISIBLE);
    ...
    private void init_clean_progress_animation() {
        ...
        value_anim_seek_progress = ObjectAnimator.ofInt(ADEInputSecurityCheckAlert.this, "progress", 0, 100);
        ...
        color_anim_clean_bg = ObjectAnimator.ofInt(this, "backColor", ADEConstants.ADE_INPUT_SECURITY_CHECK_BG_COLOR_ARRAY);
...
//
//
//                    txt_boosted_size.setText(getContext().getString(R.string.security_level));
//                } else {
...
//                txt_boosted_size.setVisibility(View.VISIBLE);
                layoutCheckResult.setVisibility(VISIBLE);
            }
        ...
        // dispear automatically after 3s
        startTimer();
    }
...
//                GAnalyticsUtils.logEvent("Boost", "Boost_Window_Dismissed");
                ...
                FloatWindowUtils.removeWindow(ADEInputSecurityCheckAlert.this);
                release();
...
//                GAnalyticsUtils.logEvent("Boost", "Boost_Back_clicked");
    ...
    private boolean isAdEnabled() {
        return PreferenceUtils.getDefaultSharedPreferencesBoolean(HSApplication.getContext().getResources().getString(R.string.input_security_check_setting_preference_key), true);
    }

    public boolean show() {
        if (!isAdEnabled() || !adAvaliable) {
            return false;
        }
