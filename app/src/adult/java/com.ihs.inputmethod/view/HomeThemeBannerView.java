...
public class HomeThemeBannerView extends FrameLayout {
	...
	public HomeThemeBannerView(Context context) {
		this(context,null);
	}

	public HomeThemeBannerView(Context context, AttributeSet attrs) {
		this(context, attrs,0);
	}

	public HomeThemeBannerView(Context context, AttributeSet attrs, int defStyleAttr) {
