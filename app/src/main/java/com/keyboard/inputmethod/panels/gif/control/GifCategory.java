...
public final class GifCategory {
    ...
    private static String mCurrentExtendedCategoryId = "";
    private static String mCurrentLogCategoryId = "";
    private static ArrayList<String> shownCategories=new ArrayList<>();
    ...
    public static String getCurrentExtendedCategoryId() {
    ...
    public static boolean isUserTab(final String categoryName){
