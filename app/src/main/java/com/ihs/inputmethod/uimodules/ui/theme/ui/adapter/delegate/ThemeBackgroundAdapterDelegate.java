                    ...
                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (!customThemeItemBase.hasLocalContent()
                                ...
                                LockerAppGuideManager.getInstance().showDownloadLockerAlert(activity, HSApplication.getContext().getResources().getString(R.string.locker_guide_unlock_for_free_dialog_title), LockerAppGuideManager.FLURRY_ALERT_UNLOCK);
                                return;
                            }
