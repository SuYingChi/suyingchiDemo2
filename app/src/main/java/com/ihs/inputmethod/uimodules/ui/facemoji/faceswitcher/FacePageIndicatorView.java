...
public class FacePageIndicatorView extends View {
	...
	public FacePageIndicatorView(final Context context, final AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public FacePageIndicatorView(final Context context, final AttributeSet attrs, final int defStyle) {
