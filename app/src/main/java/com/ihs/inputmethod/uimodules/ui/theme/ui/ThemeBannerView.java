...
public class ThemeBannerView extends CardView {
	...
	public ThemeBannerView(Context context, AttributeSet attrs) {
		this(context, attrs,0);
	}

	public ThemeBannerView(Context context, AttributeSet attrs, int defStyleAttr) {
