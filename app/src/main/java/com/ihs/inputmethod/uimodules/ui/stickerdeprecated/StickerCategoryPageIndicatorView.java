...
public class StickerCategoryPageIndicatorView extends View {
	...
	public StickerCategoryPageIndicatorView(final Context context, final AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public StickerCategoryPageIndicatorView(final Context context, final AttributeSet attrs, final int defStyle) {
