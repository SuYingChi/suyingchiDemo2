...
public class WrapFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tabTitles[0] = getActivity().getString(R.string.tab_theme);
        tabTitles[1] = getActivity().getString(R.string.tab_sticker);
        tabTitles[2] = getActivity().getString(R.string.tab_font);
