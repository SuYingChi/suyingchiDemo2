...
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.*;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.meta.MetaData;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.player_messages.ClearPlayerInstance;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.player_messages.CreateNewPlayerInstance;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.player_messages.Prepare;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.player_messages.Release;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.player_messages.Reset;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.player_messages.SetAssetsDataSourceMessage;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.player_messages.SetUrlDataSourceMessage;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.player_messages.Start;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.player_messages.Stop;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.ui.MediaPlayerWrapper;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.ui.VideoPlayerView;
import com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.utils.Logger;

import java.lang.ref.SoftReference;
import java.util.Arrays;

/**
 * This implementation of {@link com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.VideoPlayerManager} is designed to manage a single video playback.
...
public class SingleVideoPlayerManager implements VideoPlayerManager<MetaData>, VideoPlayerManagerCallback, MediaPlayerWrapper.MainThreadMediaPlayerListener {
     ...
     * then it calls {@link com.ihs.inputmethod.uimodules.widget.videoview.videoplayerview.PlayerItemChangeListener#onPlayerItemChanged(MetaData)}}
     * To notify that player was switched.
     */
    private final PlayerItemChangeListener mPlayerItemChangeListener;

    private SoftReference<VideoPlayerView> mCurrentPlayer = null;
    ...
    public void playNewVideo(MetaData currentItemMetaData, VideoPlayerView videoPlayerView, String videoUrl) {
        ...
        boolean currentPlayerIsActive = mCurrentPlayer != null && mCurrentPlayer.get() != null && mCurrentPlayer.get() == videoPlayerView;
        boolean isAlreadyPlayingTheFile =
                mCurrentPlayer != null && mCurrentPlayer.get() != null &&
                        videoUrl.equals(mCurrentPlayer.get().getVideoUrlDataSource());
    ...
    public void playNewVideo(MetaData currentItemMetaData, VideoPlayerView videoPlayerView, AssetFileDescriptor assetFileDescriptor) {
        ...
        boolean isAlreadyPlayingTheFile =
                mCurrentPlayer != null && mCurrentPlayer.get() != null &&
                        mCurrentPlayer.get().getAssetFileDescriptorDataSource() == assetFileDescriptor;
    ...
    private void stopResetCurrentPlayer() {
        ...
        if(mCurrentPlayer != null && mCurrentPlayer.get() == null) {
            return;
        }
    ...
    public void setCurrentItem(MetaData currentItemMetaData, VideoPlayerView videoPlayerView) {
        ...
        mCurrentPlayer = new SoftReference<VideoPlayerView>(videoPlayerView);
