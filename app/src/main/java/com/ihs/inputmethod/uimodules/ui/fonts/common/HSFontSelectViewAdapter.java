...
public class HSFontSelectViewAdapter extends BaseAdapter {
    ...
    OnHSFontClickListener onHSFontClickListener;
    public HSFontSelectViewAdapter(final Context context, final View parentView, OnHSFontClickListener onHSFontClickListener) {
        ...
        this.onHSFontClickListener = onHSFontClickListener;
    }
...
//        }
    ...
    private void onClickFont(final int font, final View view) {
        ...
        mAnimator.start();
        switchFont(font);
        HSGlobalNotificationCenter.sendNotification(HS_NOTIFICATION_FONT_CHANGED);
        if(onHSFontClickListener!=null){
            onHSFontClickListener.onFontClick();
        }
    ...
    public interface OnHSFontClickListener{
        void onFontClick();
    }
}
