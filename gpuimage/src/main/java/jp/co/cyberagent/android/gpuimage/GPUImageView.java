...
public class GPUImageView extends FrameLayout {
    ...
    public void setRotation(int rotation) {
        mGPUImage.setTextureTransform(new TextureTransform(rotation));
        requestRender();
    }
     ...
     */
    public void setFilter(GPUImageBaseFilter filter) {
        mFilter = filter;
     ...
     */
    public GPUImageBaseFilter getFilter() {
        return mFilter;
    }
    ...
    public void setRendererSource(GPUImageRendererSource source) {
        mGPUImage.setRendererSource(source);
    }
