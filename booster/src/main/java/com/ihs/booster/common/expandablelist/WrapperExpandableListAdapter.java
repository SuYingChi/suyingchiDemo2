...
class WrapperExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        if (convertView != null) {
            final Object tag = convertView.getTag(R.id.GroupExpandableListViewVisibility);
            ...
            convertView.setTag(R.id.GroupExpandableListViewVisibility, null);
        }
