...
public class EdgeChanger {
    ...
    private static Method RECYCLER_VIEW_METHOD_ENSURE_GLOW_LEFT;
    private static Method RECYCLER_VIEW_METHOD_ENSURE_GLOW_RIGHT;
    ...
    public static void setEdgeGlowColor(final RecyclerView recyclerView, final int color) {
        ...
        try {
            ...
            setEdgeEffectColor(RECYCLER_VIEW_FIELD_EDGE_GLOW_LEFT.get(recyclerView), color);
            setEdgeEffectColor(RECYCLER_VIEW_FIELD_EDGE_GLOW_RIGHT.get(recyclerView), color);
        } catch (final Exception | NoClassDefFoundError e) {
            e.printStackTrace();
        }
    }
